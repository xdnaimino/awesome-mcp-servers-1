...
- [io.github.xdnaimino/fast-html-mcp](https://github.com/Aimino-Tech/fast-html-mcp) - Lightning-fast HTML generation from AI agents with 9 tools, 15 components, and 10 templates.
