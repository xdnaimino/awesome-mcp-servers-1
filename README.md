...
- <img src="https://avatars.githubusercontent.com/u/197769132?s=48&v=4" height="14"/> [Fast HTML MCP](https://github.com/Aimino-Tech/fast-html-mcp) - Four-tier MCP server for lightning-fast HTML generation from AI agents. Assembly-Patch-Read-Raw architecture with 9 tools, 15 components, and 10 templates.
